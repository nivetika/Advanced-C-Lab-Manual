...
@@ -84,37 +114,33 @@ Use scanf to input the file name into the name array.
...
2.	Begin the main function.
3.	Declare a file pointer p.
@@ -131,34 +157,42 @@ Use scanf to input the file name into the name array and the number of strings i
4.	End the main function.
5.	Return 0 to indicate successful program execution.
...
Update Module 7.md · Balaji973/Advanced-C-Lab-Manual@fb17a51
